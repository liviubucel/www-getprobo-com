...
description: Set up the Probo Bridge to automatically provision, update, and deactivate Probo accounts from Google Workspace users via SCIM synchronization.
---
