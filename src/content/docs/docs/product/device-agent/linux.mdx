---
title: Linux
description: Install and enroll Probo Agent on Linux servers from the command line using install.sh or the CLI, and verify or uninstall the deployment.
---

Install and enroll Probo Agent on Linux from the command line. This path is for servers and other headless hosts where there is no tray or browser enrollment.
