---
title: Okta SSO
description: Set up SAML SSO between Okta and Probo, including domain verification, attribute statements, relay state, group-based access, and troubleshooting.
---
