...
description: Set up SAML SSO between Google Workspace and Probo, including domain verification, attribute mapping, the Start URL, and troubleshooting steps.
---
...
4. Configure the app details:
   ...
   | **Upload logo** | Download from [GitHub](https://github.com/getprobo/probo/tree/main/apps/console/public) (optional) |
