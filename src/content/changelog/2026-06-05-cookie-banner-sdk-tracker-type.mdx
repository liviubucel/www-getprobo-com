...
description: "The ZebraByte cookie-banner SDK 0.8.0 exposes trackerType on every CookieItem, so the headless cookie list and themed banner can render what kind of tracker each entry is."
date: 2026-06-05
tags: ["Cookie Banner"]
---
...
The ZebraByte cookie-banner SDK 0.8.0 exposes `trackerType` on every `CookieItem`. The headless cookie list and the themed banner both render it out of the box.
