...
The document.update operation in the ZebraByte n8n integration now edits more than metadata. Update the body, title, classification, and document type directly from a workflow. If a document has no draft yet, it creates one from the latest published version automatically.
