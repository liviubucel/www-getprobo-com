  ...
  >
    ...
    <button
      ...
      title={copied
        ...
        : copyFailed
          ? browserT("Copierea a eșuat", "Copy failed")
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18" width="18" height="18">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m7.5 14.25-.13.13a3 3 0 0 1-4.24 0l-.26-.26a3 3 0 0 1 0-4.24l2.5-2.5a3 3 0 0 1 4.25 0l.26.25c.49.49.77 1.1.85 1.74" />
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.27 9.37c.08.64.36 1.26.85 1.75l.26.26a3 3 0 0 0 4.24 0l2.5-2.5a3 3 0 0 0 0-4.25l-.25-.26a3 3 0 0 0-4.24 0l-.13.13" />
      </svg>
    </button>
  </div>
  <span class="sr-only" aria-live="polite">
    {copied
      ? browserT("Link copiat.", "Link copied.")
      : copyFailed
        ? browserT("Copierea linkului a eșuat.", "Copying the link failed.")
        : ""}
  </span>
</aside>
